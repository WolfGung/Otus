...
*** Variables ***
${USER OPENCART URL}        http://192.168.102.98/opencart/
${BROWSER}                  Firefox
${TABLETS BUTTON}           xpath://a[@href='http://192.168.102.98/opencart/index.php?route=product/category&path=57']
${GALAXY TAB PRODUCT}       xpath://a[@href='http://192.168.102.98/opencart/index.php?route=product/product&path=57&product_id=49']
${ADD PRODUCT TO CART}      id:button-cart
${OPEN BASKET BUTTON}       id:cart-total
${BASKET PRODUCT TABLE}     xpath://a[@href='http://192.168.102.98/opencart/index.php?route=product/product&product_id=49']
${REMOVE PRODUCT}           xpath://button[@title='Remove']
${CAMERAS BUTTON}           xpath://a[@href='http://192.168.102.98/opencart/index.php?route=product/category&path=33']
${CANON EOS 5D}             xpath://a[@href='http://192.168.102.98/opencart/index.php?route=product/product&path=33&product_id=30']
...
${REGISTER BUTTON}          xpath://a[@href='http://192.168.102.98/opencart/index.php?route=account/register']
...
${LOGIN BUTTON}             xpath://a[@href='http://192.168.102.98/opencart/index.php?route=account/login']
${LOGIN EMAIL FIELD}        id:input-email
${LOGIN PASSWORD FIELD}     id:input-password
${LOGIN LOGIN BUTTON}       xpath://input[@type='submit']
${LOGOUT BUTTON}            xpath://a[@href='http://192.168.102.98/opencart/index.php?route=account/logout']
